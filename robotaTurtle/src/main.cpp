...
int main(int argc, char *argv[])
{
    ...
    ros::NodeHandle nh_;
    vel_pub_ = nh_.advertise<turtlesim::Velocity>("turtle1/command_velocity", 10000);
    printf("le\n");
...
void *filter_leanalise (void *)
{
    ...
    while(ros::ok())
    {
        ...
        */
        ...
        vel.angular = (copyFrame.cols/2-localCan.x)/5;
        vel.linear = (copyFrame.rows/2-localCan.y)/5;
